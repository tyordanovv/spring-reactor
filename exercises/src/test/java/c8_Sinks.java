...
public class c8_Sinks extends SinksBase {
    ...
    public void single_shooter() {
        ...
        Mono<Boolean> operationCompleted = sink.asMono();//once sink is updated this is also updated
    ...
    public void single_subscriber() {
        Sinks.Many<Integer> sink = Sinks.many().unicast().onBackpressureBuffer(); //multiple values to a single subscriber
